...
$columns = [
    ...
    [
        'field' => 'first_name', 
        'label' => 'Name',
        'format' => 'name', // Custom format for combining first+last name
        'last_name_field' => 'last_name' // Extra field needed for this format
    ],
    ['field' => 'email', 'label' => 'Email'],
    ['field' => 'created_at', 'label' => 'Joined', 'format' => 'date'],
    ['field' => 'is_active', 'label' => 'Status', 'format' => 'status']
];
...
$search_condition = $search ? "WHERE username LIKE '%$search%' OR email LIKE '%$search%' OR first_name LIKE '%$search%' OR last_name LIKE '%$search%'" : '';

// Base query
$query = "SELECT * FROM Users $search_condition ORDER BY created_at DESC LIMIT $per_page OFFSET $offset";
